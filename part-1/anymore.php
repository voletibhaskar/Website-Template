    ...
    <div id="music_content">
        ...
        <div id="music_right_column">
        	<div class="music_right_panel_fullwidth">
				...
				<tr>
					<td height="50"><a href="rate5.php"><input class="edrbutton" type="button" name="Rate" value="Rate It"></a></td>
