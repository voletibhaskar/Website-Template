<?php
	...
	if(!empty($_SESSION['admin']))
	{
		...
		$update1="UPDATE Admin set First_Name='$name' WHERE Email_ID='$username'";
		mysql_query($update1);
		$update2="UPDATE Admin set Surname='$surname' WHERE Email_ID='$username'";
		mysql_query($update2);
		echo "<script>window.location='http://localhost/project/aprofile.php'</script>";
	}
	else
	{
?>
