<?php
	...
	if (!empty($_SESSION['admin']))
	{
		...
		$sql1="SELECT * from Contacts ORDER by S_No";
...
<meta content="text/html;charset=utf-8" http-equiv="Content-Type">
    ...
    <div id="music_menu">
     	<ul>
            ...
            <li><a href="acontacts.php" class="lastmenu" id="current">Contacts</a></li>        
        </ul>  
    </div>
    ...
    <div id="music_content">
        ...
        <div id="music_right_column">
        	<div class="music_right_panel_fullwidth">
                ...
                <div id="contact">
			<?php
				while($contact=mysql_fetch_array($result1))
				{
			?> 
                    <p><?php echo $contact['Name'];?>: &nbsp<a href="mailto:<?php echo $contact['Email_ID'];?>"><?php echo $contact['Email_ID'];?></a></p>
			<?php
				}
			?> 
