    ...
    <div id="music_content">
        ...
        <div id="music_right_column">
        	<div class="music_right_panel_fullwidth">
				...
				<tr>
					<td><input class="button b_sign_up" type="submit" name="edit" value="Yes"/></td>
					<td><a href="profile.php"><input class="button b_sign_up" type="button" name="edit" value="No"/></a></td>
				</tr>
				</table>
                 </form>                   
            </div>
