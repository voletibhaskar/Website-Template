<?php
	...
	if (!empty($_SESSION['log_in']) && !empty($_SESSION['user']))
	{
		...
		$sql1="SELECT Surname FROM Members WHERE Email_ID='$username'";
        ...
        <div id="music_right_column">
        	<div class="music_right_panel_fullwidth">
				...
				<tr>
					...
					<td><?php echo $ro['First_Name'];?></td>
				</tr>
				<tr>
					<td class="sign_up_row" height="50"><label>Surname:</label></td>
					<td><?php echo $ro1['Surname'];?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><?php echo $ro2['Artist'];?></td>
				</tr>
				<tr>
                    <td class="sign_up_row" height="50"><label>Favorite Genre</label></td>
					<td><?php echo $ro3['Genre'];?></td>
				</tr>
				<tr>
					<td colspan="2" width="100%"><a href="editpro.php"><input class="edbutton" type="button" name="edit" value="Edit Profile"/></a></td>
				</tr>
				<tr>
					<td colspan="2" width="100%"><a href="changepass.php"><input class="edbutton" type="button" name="edit" value="Change Password"/></a></td>
				</tr>
				<tr>
					<td colspan="2"><a href="delornot.php"><input class="edbutton" type="button" name="delete" value="Delete Account"/></a></td>
				</tr>
				</table>
