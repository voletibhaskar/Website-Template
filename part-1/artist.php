...
<meta content="text/html;charset=utf-8" http-equiv="Content-Type">
    ...
    <div id="music_menu">
     	<ul>
			<li><a href="home.php">Home</a></li>
            	...
            	<li><a href="artist.php" class="current">Artists</a></li>                      
    ...
    <div id="music_content">
        ...
        <div id="music_right_column">
        	...
        	<div id="new_released_section">
            	<h1>Songs By Artists</h1>
			<?php
				$astart=$csong;
						$s="SELECT Song_Name,Album,Artist,Genre,Rating FROM Songs ORDER By Artist";
						$rs=mysql_query($s);
			...
			?>
			<div id="new_released_section">
            	<h1>Songs Of <?php echo $artist;?></h1>
			<?php
