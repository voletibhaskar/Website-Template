<?php
	...
	if (!empty($_SESSION['admin']))
	{
		...
		$sql1="SELECT * FROM Members ORDER by First_Name";
    ...
    <div id="music_content">
        ...
        <div id="music_right_column">
        	<div class="music_right_panel_fullwidth">
            	<h1 align="center">Members Details</h1>
                <div id="sign_up">
				<table border="0" align="center">
				<tr>
					<th class="sign_up_row" height="50" align="center"><label>First Name</label></th>
					<th class="sign_up_row" height="50" align="center"><label>Surname</label></th>
					<th class="sign_up_row" height="50" align="center"><label>Email-ID</label></th>
					<th class="sign_up_row" height="50" align="center"><label>Fav Artist</label></th>
					<th class="sign_up_row" height="50" align="center"><label>Fav Genre</label></th>
				<?php
					while($member=mysql_fetch_array($result1))
					{
						$iddd=$member['Email_ID'];
						$sql2="SELECT Artist,Genre FROM Favorite WHERE Email_ID='$iddd'";
						$nres=mysql_query($sql2);
						$name=mysql_fetch_array($nres);
				?>
				<tr>
					<td align="center" height="50"><?php echo $member['First_Name'];?></td>
					<td align="center" height="50"><?php echo $member['Surname'];?></td>
					<td align="center" height="50"><?php echo $member['Email_ID'];?></td>
					<td align="center" height="50"><?php echo $name['Artist'];?></td>
					<td align="center" height="50"><?php echo $name['Genre'];?></td>
				</tr>
				<?php
					}
				?>
