    ...
    <div id="music_content">
        ...
        <div id="music_right_column">
            ...
            <div class="music_right_panel_fullwidth">
				...
				?>
                    <div class="more_button" style="margin-left:15px;"><a href="anews.php">View All</a></div>
                </div>
		           ...
		           <div id="topdownload_section">
					...
					?>
					<div class="more_button" style="margin-left:15px;"><a href="addsong.php">Add Song</a></div>       
		           </div>
			</div>                
