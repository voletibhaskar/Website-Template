    ...
    <div id="music_content">
        ...
        <div id="music_right_column">
        	<div class="music_right_panel_fullwidth">
            	<h1>Subpage Title goes here</h1>
                <div class="music_right_panel_fullwidth_content">
                	<h3>Subtitle 1 goes here</h3>
                    <img src="images/image01(140x140).jpg" alt="image 1" /> 
              </div> 
                
                <div class="music_right_panel_fullwidth_content">
                	<div id="sign_up">
                    <form method="post" action="changerate.php">
				<table border="0">
				<tr>
				...
				<tr>
					...
					<td><a href="song.php"><input class="Download" type="button" name="cancel" value="Cancel"></a></td>
				</tr> 
				</table>
				</form>
              </div>
